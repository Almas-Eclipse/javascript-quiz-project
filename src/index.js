...
clearInterval(timer);
  ...
  function showResults() {
    ...
    // const correctAnswers = userAnswers.filter((answer, index) => answer === questions[index].correct).length; Same as line 182/183  
    resultContainer.innerText = `You scored ${quiz.correctAnswers} out of ${totalQuestions}correct answers!`; // This value is hardcoded as a placeholder
  }
